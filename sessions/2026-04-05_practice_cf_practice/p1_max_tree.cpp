...
// integers $$$x$$$ and $$$y$$$.
// 
// Consider a permutation$$$^{\text{∗}}$$$ $$$p$$$ of the integers $$$1$$$ through
// $$$n$$$, where $$$p_i$$$ represents the value assigned to vertex $$$i$$$.
// 
// For an edge $$$(u, v)$$$, such that $$$u \lt v$$$ with associated values $$$x$$$
// and $$$y$$$, its contribution is defined as follows: $$$$$$ \begin{cases} x &
// \text{if } p_u \gt p_v, \\\ y & \text{otherwise.} \end{cases} $$$$$$
// 
...
// follows.
// 
// The first line contains a single integer $$$n$$$ ($$$2 \le n \le 2 \cdot
// 10^5$$$) — the number of vertices in the tree.
// 
// Each of the next $$$n - 1$$$ lines contains four integers $$$u$$$, $$$v$$$,
// $$$x$$$, and $$$y$$$ ($$$1 \le u \lt v \le n$$$, $$$1 \le x, y \le 10^9$$$) —
